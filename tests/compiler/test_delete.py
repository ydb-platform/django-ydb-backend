...
class TestDelete(TransactionTestCase):
    ...
    def test_delete_single(self):
        ...
        SimpleItem.objects.create(
            code="C300", category="clothing", quantity=12, in_stock=True
        )
        SimpleItem.objects.create(
            code="D400", category="electronics", quantity=3, in_stock=True
        )
        SimpleItem.objects.create(
            code="E500", category="books", quantity=7, in_stock=False
        )
        SimpleItem.objects.create(
            code="F600", category="clothing", quantity=0, in_stock=False
        )
        SimpleItem.objects.create(
            code="G700", category="books", quantity=1, in_stock=True
        )
    ...
    def test_delete_complex_condition(self):
        SimpleItem.objects.create(
            code="G500", category="books", quantity=2, in_stock=False
        )
        SimpleItem.objects.create(
            code="H600", category="clothing", quantity=4, in_stock=True
        )
        SimpleItem.objects.create(
            code="I700", category="books", quantity=1, in_stock=True
        )
        SimpleItem.objects.create(
            code="L700", category="furniture", quantity=1, in_stock=True
        )
    ...
    def test_delete_all(self):
        SimpleItem.objects.create(
            code="U600", category="clothing", quantity=4, in_stock=True
        )
        SimpleItem.objects.create(
            code="Z700", category="books", quantity=1, in_stock=True
        )
        SimpleItem.objects.create(
            code="X700", category="furniture", quantity=1, in_stock=True
        )
